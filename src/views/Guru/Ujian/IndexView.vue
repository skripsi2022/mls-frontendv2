                    ...
                    <div class="">
                        <div class="card-body" style="position: relative;">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <router-link :to="{name: 'guru.ujian.create'}" class="btn btn-primary me-md-end"
                        ...
                        <table id="data-table" class="table data-table">
                            ...
                            <tbody>
                                <tr v-for="(ujian, index) in ujian.data" :key="index">
                                    ...
                                    <td>
                                        <router-link :to="{name: 'guru.ujian.detail',params:{id:ujian.id_ujian}}"
                                            class="btn btn-info btn-sm"><i class="icon-clipboard feather"></i>Detail
                                        </router-link><br>
                                        <button class="btn btn-danger btn-sm"
                                            @click.prevent="destroy(ujian.id_ujian, index)"><i
                                                class="icon-trash-2 feather"></i>Delete</button><br>
                                        <router-link :to="{name: 'guru.soal.index', params:{id:ujian.id_ujian}}"
                                            class="btn btn-warning btn-sm"><i class="icon-settings feather"></i>Atur
                                            Soal</router-link><br>
                                        <router-link :to="{name: 'guru.nilai.index', params:{id:ujian.id_ujian}}"
                                            class="btn btn-success btn-sm"><i class="icon-list feather"></i>Nilai
                                        </router-link><br>
                                    </td>
                                </tr>
                            </tbody>
